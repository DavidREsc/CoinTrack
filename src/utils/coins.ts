...
export const getCoins = async () => {
    return new Promise<ICoinsData>(async (resolve, reject) => {
        try {
            ...
            const response = await fetch(`https://coinranking1.p.rapidapi.com/coins?referenceCurrencyUuid=_4s0A3Uuu5ML&timePeriod=24h&orderBy=marketCap&orderDirection=desc&limit=3000`, {
                "method": "GET",
                "headers": {
