...
export const calculateMetrics = (transactions: ITransaction[]) => {
    ...
    transactions.forEach(t => {
        t.coin_amount = subtractAmountSold(t.coin_amount, t.amount_sold)
        t.profit = calculateProfit(t.coin_amount, t.price!, t.coin_price)
        t.holdings = calculateHoldings(t.coin_amount, t.price!)
        t.initial_holdings = calculateHoldings(t.coin_amount, t.coin_price)
        ...
        totalAmountSold = Decimal.sum(totalAmountSold, t.amount_sold || 0).toFixed() 
    })
